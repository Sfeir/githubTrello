...
public class TrelloServiceTest {
	...
	public static void setUpBeforeClass() throws Exception {
		service = new TrelloService("0b2755de4a62ec8b473b6040e38ed6aaa60f8c6c358c3598bfd7721038247f45");
	...
	public void tearDown() throws Exception {
		moveCard(CARD_1, FIRST_LIST);
		moveCard(CARD_2, FIRST_LIST);
		moveCard(CARD_3, FIRST_LIST);
	}

	private static void moveCard(Card card, List list) {
		service.getRestWrapper().url("/cards/%s/idList?value=%s", card.getId(), list.getId()).put();
	}
